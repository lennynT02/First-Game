...
public class Main extends InputAdapter implements ApplicationListener {
    ...
    public void create () {
        ...
        koalaTexture = new Texture("characte.png");
        TextureRegion[] regions = TextureRegion.split(koalaTexture, 21, 28)[0];
        stand = new Animation<TextureRegion>(0, regions[1]);
        jump = new Animation<TextureRegion>(0, regions[0]);
        walk = new Animation<TextureRegion>(0.1f, regions[2], regions[3], regions[4]);
